...
double HCurrent::m_inf(double V, double Ca) {return 1.0/(1.0+exp((V+75.0+ac_shift_m)/5.5));}
double HCurrent::tau_m(double V, double Ca) {return (2/( exp((V+169.7)/(-11.6)) + exp((V-26.7)/(14.3)) ));}
// double HCurrent::tau_m(double V, double Ca) {return (2/( exp((V+169.7+ac_shift_m)/(-11.6)) + exp((V-26.7+ac_shift_m)/(14.3)) ));}
