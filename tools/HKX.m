...
classdef HKX
  ...
  methods
    ...
    function connect_default_pyloric(self)
      ...
      % self.x.connect('AB','LP','prinz/Chol','gmax', 30); % extra
    end
  
    function connect_pyloric(self)
      self.x.connect('AB','LP','prinz/Glut','gmax', 3);
      self.x.connect('AB','LP','prinz/Chol','gmax', 100);
      self.x.connect('AB','PY','prinz/Glut','gmax', 10);
      self.x.connect('AB','PY','prinz/Chol','gmax', 1);
      self.x.connect('LP','PY','prinz/Glut','gmax', 3);
      self.x.connect('PY','LP','prinz/Glut','gmax', 10);
      self.x.connect('LP','AB','prinz/Glut','gmax', 10);
    end
